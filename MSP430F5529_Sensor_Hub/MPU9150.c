...
#define MPU6050_GYRO_OUT        0x43     	//MPU6050 gyro register
#define MPU6050_ACC_OUT         0x3B     	//MPU6050 accel register

//#define MPU6050_SLAVE_ADDRESS  0xd0      //MPU6050 read address
...
{
  setI2CAddress(MPU9150_RA_MAG_ADDRESS);
  TxData[0]=addr;
  TxData[1]=data;
  sendI2C(TxData,2,STOP);
}
